...
export const createTransaction = async (req: RequestWithFile, res: Response): Promise<void> => {
    try {
        const transactionData = req.body;

        if (req.file) {
            transactionData.paymentProof = req.file.filename;
        }   else {
...
export const updateTransaction = async (req: RequestWithFile, res: Response): Promise<void> => {
    try {
